...
var signupForm = yo`<div class="col s12 m7">
  <div class="row">
    <div class="signup-box">
      ...
      <form class="signup-form">
        <h2>${translate.message('signup_subheading')}</h2>
        <div class="section">
        ...
        <div class="section">
            ...
            <div class="input-field">
              ...
              <label for="name">${translate.message('fullname')}</label>
            </div>
          ...
          <button class="btn waves-effect waves-light btn-signup" type="submit">${translate.message('signup_call_to_action')}</button>
        </div>
      </form>
    </div>
  </div>
  <div class="row">
    <div class="login-box">
      ${translate.message('signup_have_account')} <a href="/signin">${translate.message('signin')}</a>
    </div>
  </div>
</div>
</div>`;
